...
await put('/records/AAAA/@', [
  {data: '2606:50c0:8000::153', ttl: 600},
  {data: '2606:50c0:8001::153', ttl: 600},
  {data: '2606:50c0:8002::153', ttl: 600},
  {data: '2606:50c0:8003::153', ttl: 600},
]);
...
const shown = current.filter((r) => (r.type === 'A' && r.name === '@') || (r.type === 'CNAME' && r.name === 'www') || (r.type === 'AAAA' && r.name === '@'));
