...
export const pages = [
  ...
  },
  {
    ...
    body:`${intro('Current evidence','Network and tooling status','Find out what is active, what is still being built and when the evidence was checked. A working protocol rule does not mean every wallet or application supports it.')}
      ...
      ${detail('How activation was checked', `<p>The v2.0.0 release set Toccata activation at DAA score 474,165,565. Parker’s 14 September 2026 public reading (DAA 539,569,173) is above that threshold. Rechecked 15 Sep 2026: rusty-kaspa v2.0.1 is still the newest tagged release. KIP-16, KIP-17, KIP-20, and KIP-21 are marked Active in the checked repository.</p><p>This supports protocol activation, not universal wallet support, application adoption, or the absence of operational problems. Instant-finality claims remain wrong. vProgs still have no tags. KIP-2 is still Proposed.</p><p>${link('Activation release','https://github.com/kaspanet/rusty-kaspa/releases/tag/v2.0.0')} · ${source('kips')}</p>`)}
