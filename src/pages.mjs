...
export const pages = [
  {
    ...
    body: `<div class="welcome" data-welcome role="dialog" aria-modal="true" aria-label="Kaspa Explained STP">
        <div class="welcome-card">
          ...
          <p class="welcome-copy">Bitcoin: proof of work for money you actually own.<br>Stake replaced work with capital.<br>Kaspa kept the work and made confirmation internet-speed. Programmable on top.</p>
          <button class="primary-button" type="button" data-welcome-close>Continue</button>
        </div>
      </div>
      <p class="home-ethos">Bitcoin: proof of work for money you actually own.<br>Stake replaced work with capital.<br>Kaspa kept the work and made confirmation internet-speed. Programmable on top.</p>
