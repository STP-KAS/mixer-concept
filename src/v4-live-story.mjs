...
export const V4_LIVE_STORY=Object.freeze([
  {
    ...
    "line": "Sprout needs a greenhouse, and Pip wants to organize it himself. The supplier will trade, but a promise from a robot is not enough. Put a window frame, water pump and seedlings up for sale.",
  ...
  },
  {
    ...
    "line": "Pip wants to shop without asking you to approve every payment. You want to keep the rest of your wallet safe. Agree on a small purse, a recipient and a spending cap.",
  ...
  },
  {
    ...
    "line": "Pip calls its oversized payment urgent. Try the request: the app checks the agreed cap before signing, so a persuasive excuse cannot move the coins.",
  ...
  },
  {
    ...
    "line": "Pip can send a message saying it paid. The supplier wants something it can check. Send the permitted preparation payment and follow the connected node’s acceptance report.",
  ...
  },
  {
    ...
    "line": "The supplier refuses to hand over the parts before payment. Pip refuses to pay before receiving them. Put both sides of the deal in one transaction so neither has to go first.",
  ...
  },
  {
    ...
    "line": "Pip has the window frame, pump and seedlings. Finish the sale records to free their test-coin deposits; the parts stay in the game inventory for the greenhouse.",
  ...
  },
  {
    ...
    "line": "Pip has finished the deal. Use your recovery key to bring the remaining purse home; you do not need Pip’s cooperation to close it.",
  ...
  },
  {
    ...
    "line": "The parts are ready, but the greenhouse still needs backers and workers. Visit Sprout before finding them. Its movement state has only three energy for this trip.",
  ...
  },
  {
    ...
    "line": "Sprout takes one neighboring step and uses one energy. Its next state must follow the same movement rule everyone can inspect.",
    "button": "Follow Sprout",
    "networkKey": null,
    "chapterName": "Care",
    ...
    "effect": {
      ...
      "after": "Sprout’s position changes and energy falls by one",
      "next": "Keep walking toward the site"
    },
    "resultTitle": "Sprout moved. One energy spent."
  },
  {
    "id": "move-2",
    "kind": "terrarium",
    "title": "The old energy cannot be spent twice.",
    "line": "Sprout takes another step. The spent state cannot be reused to pretend its energy is still full; the new state carries the smaller reserve.",
    ...
    "effect": {
      ...
      "after": "Sprout moves again with one less energy",
  ...
  },
  {
    ...
    "line": "The final step uses the last energy. Close this visit next, then help Pip turn the parts into a greenhouse that can supply the habitat.",
    "button": "Use the last step",
    "networkKey": null,
    "chapterName": "Care",
    ...
    "resultTitle": "Sprout has used its last energy."
  },
  {
    "id": "habitat-refund",
    "kind": "terrarium",
    "title": "Close the visit and keep moving.",
    "line": "Return the movement state’s remaining deposit to your wallet. Sprout stays in the town, but closing the on-chain session does not refill its energy.",
  ...
  },
  {
    ...
    "line": "Pip has the parts. Three backers will fund the greenhouse only if the others join. Create separate pledges whose release requires all three to be ready.",
  ...
  },
  {
    ...
    "line": "Approve your contribution. One ready backer cannot collect the project’s coins or spend anyone else’s pledge. Pip and the third backer must decide too.",
  ...
  },
  {
    ...
    "line": "Pip approves its own pledge. The beneficiary still cannot collect early: two backers cannot sign for the third.",
  ...
  },
  {
    ...
    "line": "The third backer can delay its approval while the game delivery is missing. Restore any shortage, then sign the last pledge. Readiness records approval, not proof of a physical delivery.",
  ...
  },
  {
    ...
    "line": "All three pledges are ready. Release them together to the agreed beneficiary. The game combines that funding with Pip’s parts to open Sprout’s greenhouse.",
  ...
  },
  {
    ...
    "line": "The greenhouse needs a workable schedule. Offer a reward for an assignment the contract can check, so a worker cannot collect merely by claiming success.",
  ...
  },
  {
    ...
    "line": "Pip submits a schedule. Choose distinct workers and keep the cost within six, then check the assignment and worker payment together. A bad answer gets no reward.",
  ...
  },
  {
    ...
    "line": "Recover the job’s spare deposit. Pip has traded and organized the build through checked agreements; now deliver the game harvest to Sprout to finish the town’s first goal.",
