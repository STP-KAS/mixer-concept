...
const contentPages=[...pages,...doorPages,moneyPage,...(standalone?[]:[{...publicAppsPage,body:'<nav class="reading-next" aria-label="Town adventure"><p>Prefer one connected adventure?</p><a href="/covenants">Play a KAS economy: build, work, trade and deliver →</a></nav>'+publicAppsPage.body},v4Page,wrapPage,peglabPage])];
