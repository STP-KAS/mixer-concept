...
- npm run check validates the current build and offline tests. Also verify relevant browser journeys and network behavior; a build is not visual or protocol evidence.
